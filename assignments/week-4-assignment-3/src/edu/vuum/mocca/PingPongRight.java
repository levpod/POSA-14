...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        private String mPrintString = null;
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	this.mSemaphores[FIRST_SEMA] = semaphoreOne;
        	this.mSemaphores[SECOND_SEMA] = semaphoreTwo;
           	this.mPrintString = stringToPrint;
        }
        ...
        public void run() {
        	...
        	{
        		acquire();
        		System.out.println(this.mPrintString + "(" + i + ")");
        		release();
        	}
        	mLatch.countDown();
        }
